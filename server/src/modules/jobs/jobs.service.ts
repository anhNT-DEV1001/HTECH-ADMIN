...
export class JobsService {
    ...
    async updateJobService(dto: JobDto, id: number, user: User) {
        try {
            ...
            const jobData = {
                title_vn: dto.title_vn || job.title_vn,
                slug: newSlug,
                title_en: dto.title_en || job.title_en,
                job_type_vn: dto.job_type_vn || job.job_type_vn,
                job_type_en: dto.job_type_en || job.job_type_en,
                experience_vn: dto.experience_vn || job.experience_vn,
                experience_en: dto.experience_en || job.experience_en,
                description_vn: dto.description_vn || job.description_vn,
                description_en: dto.description_en || job.description_en,
                recruitment_url: dto.recruitment_url || job.recruitment_url,

                is_active: dto.is_active ?? job.is_active,
                sort_order: dto.sort_order ?? job.sort_order,

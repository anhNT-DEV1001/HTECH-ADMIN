...
export default function ResourceModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
      <article className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden">
        <header className="flex items-center justify-between p-4">
          <h2 className="text-lg font-bold text-gray-800">
            {data ? `Chỉnh sửa: ${data.alias}` : "Thêm mới tài nguyên"}
          </h2>
          <button
            onClick={onClose}
              ...
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    setTimeout(() => setIsAppending(false), 300); // Debounce 300ms
                  }}
                  className="flex items-end gap-1 bg-blue-50 text-blue-600 px-3 py-1.5 rounded-md text-xs hover:bg-blue-100 disabled:opacity-50"
                >
                  <Plus size={14} /> Thêm
                </button>
              </div>
              ...
              >
                <table className="w-full text-sm">
                  <thead className="bg-gray-50 border-b">
                    <tr>
                      <th className="p-2 text-center w-12 sticky top-0 z-10 bg-gray-50">STT</th>
                      <th className="p-2 text-center sticky top-0 z-10 bg-gray-50">Mã</th>
                      <th className="p-2 text-center sticky top-0 z-10 bg-gray-50">Đường dẫn</th>
                      <th className="p-2 text-center w-32 sticky top-0 z-10 bg-gray-50">Trạng thái</th>
                      <th className="p-2 text-center w-12 sticky top-0 z-10 bg-gray-50"></th>
                    </tr>
                  </thead>
                  <tbody>
